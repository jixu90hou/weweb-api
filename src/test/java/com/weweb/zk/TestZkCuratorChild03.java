...
public class TestZkCuratorChild03 {
    private static final Logger logger = LoggerFactory.getLogger(TestZkCuratorChild03.class);
    // Callable形式的Cache
    ...
    public static void main(String[] args) {
        ...
        try {
          ...
          /*  PathChildrenCacheListener listener = (c1, event) -> {
            ...
            cache.start();
            synchronized (TestZkCuratorChild03.class) {
                TestZkCuratorChild03.class.wait();
            }
