...
public class TestZkCuratorChild04 {
    private static final Logger logger = LoggerFactory.getLogger(TestZkCuratorChild04.class);
    // Callable形式的Cache
    ...
    public static void main(String[] args) {
        ...
        try {
          ...
          /*  PathChildrenCacheListener listener = (c1, event) -> {
            ...
            cache.start();
            synchronized (TestZkCuratorChild04.class) {
                TestZkCuratorChild04.class.wait();
            }
