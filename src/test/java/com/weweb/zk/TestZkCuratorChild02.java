...
public class TestZkCuratorChild02 {
    private static final Logger logger = LoggerFactory.getLogger(TestZkCuratorChild02.class);
    // Callable形式的Cache
    ...
    public static void main(String[] args) {
        ...
        try {
          ...
          /*  PathChildrenCacheListener listener = (c1, event) -> {
            ...
            cache.start();
            synchronized (TestZkCuratorChild02.class) {
                TestZkCuratorChild02.class.wait();
            }
