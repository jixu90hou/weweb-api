...
public class TestZkCuratorChild05 {
    private static final Logger logger = LoggerFactory.getLogger(TestZkCuratorChild05.class);
    // Callable形式的Cache
    ...
    public static void main(String[] args) {
        ...
        try {
          ...
          /*  PathChildrenCacheListener listener = (c1, event) -> {
            ...
            cache.start();
            synchronized (TestZkCuratorChild05.class) {
                TestZkCuratorChild05.class.wait();
            }
